...
public class AdminClientFactory {
    /**
     * 创建AdminClient客户端对象
     * 配置项参考：https://www.orchome.com/677
     */
    public static AdminClient createAdminClientByProperties() {
        ...
        // 配置Kafka服务的访问地址及端口号
        prop.setProperty(AdminClientConfig.BOOTSTRAP_SERVERS_CONFIG, "192.168.8.147:9092");
    ...
    public static AdminClient createAdminClientByMap() {
        ...
        // 配置Kafka服务的访问地址及端口号
        conf.put(AdminClientConfig.BOOTSTRAP_SERVERS_CONFIG, "192.168.8.147:9092");
