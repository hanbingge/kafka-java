package com.gupaoedu.vip.mq.kafka.javaapi.admin;
...
public class TopicManage {
     ...
     * 获取topic的描述信息
     *
     * topic name = a-topic, desc = (name=a-topic, internal=false, partitions=(partition=0, leader=192.168.8.147:9092 (id: 0 rack: null), replicas=192.168.8.147:9092 (id: 0 rack: null), isr=192.168.8.147:9092 (id: 0 rack: null)), authorizedOperations=null)
     * topic name = b-topic, desc = (name=b-topic, internal=false, partitions=(partition=0, leader=192.168.8.147:9092 (id: 0 rack: null), replicas=192.168.8.147:9092 (id: 0 rack: null), isr=192.168.8.147:9092 (id: 0 rack: null)), authorizedOperations=null)
     */
